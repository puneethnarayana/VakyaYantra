 ...
 * @author GSS Murthy
 */
public class sandhiJoin {

    public String process(String string1,String string2) {
        ...
        for (int w = 0;; w++) {
            {
                ...
                int flag12 = 0;
                section18:/*final visarga preceded by any vowel other than 'a' or 'A' */
