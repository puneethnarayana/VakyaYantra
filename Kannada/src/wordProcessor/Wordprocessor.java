...
public class Wordprocessor extends javax.swing.JFrame {
    ...
    public Wordprocessor(java.awt.Frame parent, boolean modal) throws MalformedURLException, IOException {
       // super(parent, modal);
        initComponents();
    ...
    private void initComponents() throws MalformedURLException, IOException {
        ...
        //setting font code
        try {
        	URL fontUrl= new URL("file:///"+new File(".").getCanonicalPath()+"/Malige-b.TTF");
       ...
       // jTextPane1.setFont(new java.awt.Font("Tunga", 0, 18)); // NOI18N
...
try {
	...
	if(evt.getComponent() == this.jTextPane4 )
		...
		System.out.println(encod.get_raw_to_dvn_view(str1));
